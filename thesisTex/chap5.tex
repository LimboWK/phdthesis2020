...
\begin{table}[H]
	...
	\end{minipage}
\end{table}
The fit bias uncertainties is determined by the fit error of 100000 \textit{signal MC} events, which is $\delta {\mathcal{S}}=0.009817$ and $\delta {\mathcal{A}}=0.005702$.
\begin{table}[H]
	\begin{minipage}[b]{1.0\linewidth}
		\centering
